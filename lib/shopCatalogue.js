...
const SHOP_ITEMS = [
  ...
  // ── Premium Colors (with special effects) ──────────────────────────────
  { id: 'color_gold',      type: 'color', value: '#ffd700', name: '✨ Shimmering Gold',       price: 1000,  preview: '#ffd700', effect: 'shimmer' },
  { id: 'color_platinum',  type: 'color', value: '#e5e4e2', name: '💎 Platinum Gleam',       price: 2500,  preview: '#e5e4e2', effect: 'gleam' },
  { id: 'color_diamond',   type: 'color', value: '#b9f2ff', name: '✦ Diamond Sparkle',       price: 5000,  preview: '#b9f2ff', effect: 'sparkle' },
  { id: 'color_aurora',    type: 'color', value: '#ff6bcb', name: '🌌 Aurora Borealis',      price: 10000, preview: '#ff6bcb', effect: 'rainbow' },
  { id: 'color_nebula',    type: 'color', value: '#2a0845', name: '🌠 Cosmic Nebula',        price: 50000, preview: '#2a0845', effect: 'nebula' },
  { id: 'color_infinity',  type: 'color', value: '#ffed4e', name: '♾️  Infinity Gold',        price: 100000, preview: '#ffed4e', effect: 'infinity' },
  { id: 'color_prism',     type: 'color', value: '#ff00ff', name: '🌈 Prismatic Legend',     price: 500000, preview: '#ff00ff', effect: 'prism' },
];
